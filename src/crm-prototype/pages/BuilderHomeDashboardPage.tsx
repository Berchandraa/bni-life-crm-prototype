...
export default function Index() {
  ...
  const visibleTickets = tickets.filter((ticket) =>
    [ticket.id, ticket.nasabah, ticket.kategori, ticket.prioritas, ticket.sla].some((value) =>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              ...
              <div className="p-1 rounded-lg bg-[#FAFAFA]">
                <div className="flex flex-col gap-6 p-3.5 rounded-lg border border-[#EFEFEF] bg-white">
                  ...
                  <button
                    onClick={() => {
                      window.history.pushState({}, "", "/telepon");
                      window.dispatchEvent(new PopStateEvent("popstate"));
                    }}
                    className="w-full py-2 px-4 rounded-md border border-[#015570] bg-white text-[#015570] text-base font-semibold hover:bg-[#015570]/5 transition-colors shadow-sm"
                  >
                    Lihat Detail
                  </button>
                </div>
              ...
              <div className="p-1 rounded-lg bg-[#FAFAFA]">
                <div className="flex flex-col gap-6 p-3.5 rounded-lg border border-[#EFEFEF] bg-white">
                  ...
                  <button
                    onClick={() => {
                      window.history.pushState({}, "", "/antrian");
                      window.dispatchEvent(new PopStateEvent("popstate"));
                    }}
                    className="w-full py-2 px-4 rounded-md border border-[#16A341] bg-white text-[#16A341] text-base font-semibold hover:bg-[#16A341]/5 transition-colors shadow-sm"
                  >
                    Lihat Detail
                  </button>
                </div>
              ...
              <div className="p-1 rounded-lg bg-[#FAFAFA]">
                <div className="flex flex-col gap-6 p-3.5 rounded-lg border border-[#EFEFEF] bg-white">
                  ...
                  <button onClick={() => showNotice("Video call belum tersedia karena tidak ada antrian")} className="w-full py-2 px-4 rounded-md border border-[#FCC799] bg-white text-[#FAA866] text-base font-semibold hover:bg-[#FFF3E8] opacity-80 shadow-sm">
                    Mulai Video
                  </button>
                </div>
              </div>
                ...
                <div className="p-1 flex-1 bg-white">
                  <div className="p-3.5 rounded-lg border border-[#EFEFEF] bg-[#FAFAFA] h-full">
                    <div className="flex items-center gap-4 flex-wrap sm:flex-nowrap">
                      ...
                      <div className="flex flex-col gap-1 flex-1 min-w-0">
                        {konteksValue.map((item: DonutData, idx: number) => (
            ...
            <div className="p-3.5 rounded-lg bg-white flex flex-col gap-3.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-md text-base font-semibold text-[#F47920] hover:bg-[#FFF3E8] transition-colors"
                >
                  Lihat Semua
                </button>
              </div>
              ...
              <div className="border border-[#EFEFEF] rounded-lg overflow-x-auto">
                      ...
                      <tr key={t.id} className="border-b border-[#EFEFEF] last:border-b-0 hover:bg-[#FAFAFA] transition-colors">
                        ...
                        <td className="px-6 py-4 text-center">
                          {t.actionType === "primary" ? (
                            <button
                              onClick={() => {
                                window.history.pushState({}, "", "/tickets/detail");
                                window.dispatchEvent(new PopStateEvent("popstate"));
                              }}
                              className="px-3.5 py-1.5 rounded-md bg-[#F47920] text-[#FAFAFA] text-sm font-semibold shadow-sm hover:bg-[#D4640F] transition-colors"
                            >
                              {t.action}
                            </button>
                          ) : (
                            <button
                              ...
                              className="px-3.5 py-1.5 rounded-md border border-[#FAA866] bg-[#FAFAFA] text-[#F47920] text-sm font-semibold shadow-sm hover:bg-[#FFF3E8] transition-colors"
                            >
                              {t.action}
                            </button>
                          )}
                ...
                {visibleTickets.length === 0 ? (
                  <div className="px-6 py-8 text-center text-sm text-[#7C7C7C]">Tidak ada tiket yang cocok dengan pencarian.</div>
                ) : null}
              </div>
            </div>
          </section>
